 ...
 <div class="modal fade" id="editModalCenter" tabindex="-1" role="dialog" aria-labelledby="editModalCenterTitle"
     ...
     <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
         <form class="modal-content" action="{{ url('/penyakit') }}" method="POST" id="editForm">
             @csrf
             @method('PUT')

             <div class="modal-header">
                 <h5 class="modal-title" id="editModalCenterTitle">Form Edit Penyakit
                 </h5>
                 ...
                 <div class="form-group mb-3">
                     ...
                     <div class="form-group position-relative has-icon-right">
                         <input type="text" class="form-control" placeholder="Input Nama Penyakit" required
                             name="penyakit_nama" id="penyakit_nama">
