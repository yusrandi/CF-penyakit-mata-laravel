 ...
 <div class="modal fade" id="editModalCenter" tabindex="-1" role="dialog" aria-labelledby="editModalCenterTitle"
     ...
     <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
         <form class="modal-content" action="{{ url('/basispengetahuan') }}" method="POST" id="editForm">
             @csrf
             @method('PUT')

             <div class="modal-header">
                 <h5 class="modal-title" id="editModalCenterTitle">Form Edit Basis Pengetahuan
                 </h5>
             ...
             <div class="modal-body">
                 <div class="form-group mb-3">
                     ...
                     <select class="form-select" required name="penyakit_id" id="penyakit_id">
                 ...
                 <div class="form-group mb-3">
                     ...
                     <select class="form-select" required name="gejala_id" id="gejala_id">
                 ...
                 <div class="form-group mb-3">
                     ...
                     <div class="form-group position-relative has-icon-right">
                         <input type="text" class="form-control" placeholder="0.2" required name="bobot" id="bobot">
