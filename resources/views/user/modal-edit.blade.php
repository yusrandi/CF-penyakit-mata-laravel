 ...
 <div class="modal fade" id="editModalCenter" tabindex="-1" role="dialog" aria-labelledby="editModalCenterTitle"
     ...
     <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
         <form class="modal-content" action="{{ url('/user') }}" method="POST" id="editForm">
             @csrf
             @method('PUT')

             <div class="modal-header">
                 <h5 class="modal-title" id="editModalCenterTitle">Form Edit Pengguna
                 </h5>
             ...
             <div class="modal-body">
               ...
               <div class="form-group mb-3">
                   ...
                   <div class="form-group position-relative has-icon-right">
                       <input type="password" class="form-control" placeholder="new password ?" minlength="8"
                           name="password">
                   </div>
               </div>
